...
<!--About-->
     <div class="about section" id="section-2" style="height: 720px;">
	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">		  
		 ...
		 <div class="col-md-4 about-grids">
             ...
             <br><br><br><br><div align="right"><a href="aboutus.php"><input type="button" value="Read More" name="sbmt" /></a></div> 
		 </div>
	 </div>
</div>
<!--/About-->
...
<div class="tour-guides section" id="section-4" style="height: 720px;" >
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
				  		<div class="logo"><a href="index.php#section-1"><img src="images/logo_2.png" alt=""/>travelix</a></div><br><br><br><br>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 9163457180&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 8910296119</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="mailto:avirupbhakat@gmail.com?">avirupbhakat@gmail.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>11, Nidhi ram majhi lane Howrah, 711101</h5>
                        <br/>
						<div class="mapouter"><div class="gmap_canvas"><iframe width="400" height="300" id="gmap_canvas" src="https://maps.google.com/maps?q=11%2C%20Nidhiram%20Majhi%20Lane%2C%20Naora%2C%20Shibpur%2C%20Howrah%2C%20West%20Bengal%20711101%2C%20India&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://google-map-generator.com">google map generator</a></div><style>.mapouter{position:relative;text-align:right;height:300px;width:400px;}.gmap_canvas {overflow:hidden;background:none!important;height:300px;width:400px;}</style></div>
                      </div>
...
?>
					  <form method="post">
                      <table border="0" width="450px" height="500px">
					 ...
					 <tr><td align="left"><textarea onFocus="if(this.value == 'Message') this.value='';" name="t4" onBlur="if(this.value == '') this.value='Enter Message Here';" required style="margin:0px; width: 400px; height:150px;">Message</textarea></td></tr>
