	 <div class="header-top">
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
						<a href="index.php#section-1"><img src="images/logo_2.png" alt=""/>travelix</a>
						</div>
						<div class="menu">
						<ul id="nav">
							 <li class="current"><a href="index.php#section-1"  onclick="javascript:window.open('index.php#section-1','_self')">                            Home</a></li>
                        	 ...
                        	 <li><a href="category.php#section-6" onclick="javascript:window.open('category.php','_self')">Category</a></li>                             
